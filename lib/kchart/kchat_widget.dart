...
import 'package:quant/generated/l10n.dart' as res;
...
class _KChartWidgetState extends State<KChartWidget>
  ...
  List<String> infoNames = [
    res.S.of(G.getCurrentContext()).date,
    res.S.of(G.getCurrentContext()).open,
    res.S.of(G.getCurrentContext()).high,
    res.S.of(G.getCurrentContext()).low,
    res.S.of(G.getCurrentContext()).close,
    res.S.of(G.getCurrentContext()).chg,
    res.S.of(G.getCurrentContext()).chg_percent,
    res.S.of(G.getCurrentContext()).vol
  ];
  List infos;
